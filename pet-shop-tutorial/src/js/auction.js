var web3 = new Web3();
web3.setProvider(new web3.providers.HttpProvider("https://ropsten.infura.io/v3/9dd7bf8458d145328acb640fcd0b1179");
        var bidder = web3.eth.accounts[0]; web3.eth.defaultAccount = bidder;
        var auctionContract = web3.eth.contract(0x91CF84FFdb29Ca3B99c174D9842378D6CD6c2899); // ABI omitted to make the code concise
        ...
        function bid() {
            ...
            auction.bid({
                ...
                if (error) {
                    ...
                    //document.getElementById('biding_status').innerHTML = 'Think to
                    //bidding higher';
                } else {
